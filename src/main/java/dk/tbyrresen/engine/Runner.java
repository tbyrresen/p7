...
//                                                            edge418, edge1812, edge619, edge1914));
        ...
        System.out.println("pre proc nodes: " + preProcessedGraph.getNodes().size());
        System.out.println("pre proc edges: " + preProcessedGraph.getEdges().size());
        var ndTree = new NestedDissectionTree<>(preProcessedGraph, 0.6);
...
//        var nd = NestedDissector.dissect(largestCC.get(), 0.6);
//        System.out.println(nd.size());


//        var roadNetwork = new StandardGraph<>(nodes, edges);
//        var nd = NestedDissector.dissect(roadNetwork, 0.6);
//        for (var dissection : nd) {
